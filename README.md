...
Todas as alterações, propostas de código ou modificações técnicas geradas por Inteligência Artificial no repositório ADS INTELLIGENCE exigem obrigatoriamente uma revisão humana detalhada antes de qualquer processo de merge. A supervisão humana é indispensável para garantir a integridade, segurança e qualidade do sistema.
