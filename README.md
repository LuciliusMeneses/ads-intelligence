...
Todas as alterações ou código gerados por sistemas de IA devem ser obrigatoriamente revistos por um humano antes de qualquer processo de merge. A supervisão humana é essencial para garantir a qualidade, segurança e conformidade do código.
