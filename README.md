...
Todas as alterações ao código geradas por inteligência artificial exigem revisão humana obrigatória antes de qualquer merge no repositório. A supervisão técnica garante a integridade e segurança do sistema.
