 ...
 * STRICT: Enforces organization_id filtering on every query.
 */

import { SpecialistContext, MarketReference } from '../types/intelligence';
import { ExpertRole } from '../types/ads-intelligence';

export class SpecialistContextBuilder {
  /**
   * Filters and builds the specialized context payload for a specific specialist role,
   * guaranteeing zero data leakage across organization_id boundaries.
   */
